...
interface SelectGroupTwoProps {
  ...
  options: { id: string | number; name: string }[];  // options là một mảng các đối tượng có thuộc tính id và name
  ...
  setForm: any;
  disabled?: boolean;      // disabled là prop tùy chọn để tắt chọn
}
