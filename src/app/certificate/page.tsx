			...
			<div className="flex flex-col gap-10">
				<div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
					<div className="px-4 py-6 md:px-6 xl:px-7.5 md:flex md:justify-between w-full">
						...
						<Link href={'/certificate/form'} className="inline-flex items-center justify-center rounded-md bg-orange-400 px-10 py-2 text-center font-medium text-white hover:bg-opacity-90 lg:px-8 xl:px-10">Tạo mới</Link>
					</div>
										...
										<tr key={key}>
											...
											<td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
												<div className="flex items-center space-x-3.5">
													...
													<Link href={'/certificate/form?id=' + item.id} className="hover:text-orange-400"
													>
														<FaPencil />
													</Link>
												</div>
