			...
			<div className="flex flex-col gap-10">
				<div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
					<div className="px-4 py-6 md:px-6 xl:px-7.5 md:flex md:justify-between w-full">
						...
						{user?.userType == 'ADMIN' && <Link href={'/salary/form'} className="inline-flex items-center justify-center rounded-md bg-orange-400 px-10 py-2 text-center font-medium 
										...
										<tr key={key}>
											...
											{user?.userType == 'ADMIN' && <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
												<div className="flex items-center space-x-3.5">
													...
													<Link href={'/salary/form?id=' + item.id} className="hover:text-orange-400"
													>
														<FaPencil />
													</Link>
												</div>
